...
export default function AdminDashboard() {
  ...
  return (
    <div className="p-4 lg:p-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8 mb-8 lg:mb-12">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 lg:p-8 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-4 lg:mb-6">
            ...
            <div className="text-right">
              <p className="text-2xl lg:text-3xl font-bold text-gray-900">{stats.technicalTrainings}</p>
              <p className="text-xs lg:text-sm text-gray-600">Total</p>
            </div>
          </div>
          <h3 className="text-lg lg:text-xl font-semibold text-gray-900 mb-2 lg:mb-3">Technical Trainings</h3>
          <p className="text-sm lg:text-base text-gray-600 mb-4 lg:mb-6 leading-relaxed">Engineering and technical skill development programs</p>
          <a
            href="/admin/technical-trainings"
            className="inline-flex items-center text-xs lg:text-sm font-medium text-blue-600 hover:text-blue-700 transition-colors"
          >
            Manage Trainings
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 lg:p-8 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-4 lg:mb-6">
            ...
            <div className="text-right">
              <p className="text-2xl lg:text-3xl font-bold text-gray-900">{stats.nonTechnicalTrainings}</p>
              <p className="text-xs lg:text-sm text-gray-600">Total</p>
            </div>
          </div>
          <h3 className="text-lg lg:text-xl font-semibold text-gray-900 mb-2 lg:mb-3">Non-Technical Trainings</h3>
          <p className="text-sm lg:text-base text-gray-600 mb-4 lg:mb-6 leading-relaxed">Management and soft skills development programs</p>
          <a
            href="/admin/non-technical-trainings"
            className="inline-flex items-center text-xs lg:text-sm font-medium text-green-600 hover:text-green-700 transition-colors"
          >
            Manage Trainings
            <ArrowRightIcon className="ml-2 w-3 h-3 lg:w-4 lg:h-4" />
          </a>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 lg:p-8 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-4 lg:mb-6">
            ...
            <div className="text-right">
              <p className="text-2xl lg:text-3xl font-bold text-gray-900">{stats.consultingServices}</p>
              <p className="text-xs lg:text-sm text-gray-600">Total</p>
            </div>
          </div>
          <h3 className="text-lg lg:text-xl font-semibold text-gray-900 mb-2 lg:mb-3">Consulting Services</h3>
          <p className="text-sm lg:text-base text-gray-600 mb-4 lg:mb-6 leading-relaxed">Professional consulting and advisory services</p>
          <a
            href="/admin/services"
            className="inline-flex items-center text-xs lg:text-sm font-medium text-purple-600 hover:text-purple-700 transition-colors"
          >
            Manage Services
            <ArrowRightIcon className="ml-2 w-3 h-3 lg:w-4 lg:h-4" />
          </a>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 lg:p-8 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-4 lg:mb-6">
            ...
            <div className="text-right">
              <p className="text-2xl lg:text-3xl font-bold text-gray-900">{stats.contacts}</p>
              <p className="text-xs lg:text-sm text-gray-600">Total</p>
            </div>
          </div>
          <h3 className="text-lg lg:text-xl font-semibold text-gray-900 mb-2 lg:mb-3">Contact Messages</h3>
          <p className="text-sm lg:text-base text-gray-600 mb-4 lg:mb-6 leading-relaxed">Inquiries and contact form submissions</p>
          <a
            href="/admin/contacts"
            className="inline-flex items-center text-xs lg:text-sm font-medium text-red-600 hover:text-red-700 transition-colors"
          >
            View Messages
            <ArrowRightIcon className="ml-2 w-3 h-3 lg:w-4 lg:h-4" />
          </a>
      ...
      {/* Quick Actions */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 lg:p-8 mb-8 lg:mb-12">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6 lg:mb-8">
          <h2 className="text-xl lg:text-2xl font-semibold text-gray-900 mb-2 lg:mb-0">Quick Actions</h2>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 lg:p-8">
        <h2 className="text-xl lg:text-2xl font-semibold text-gray-900 mb-6 lg:mb-8">System Overview</h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-8">
          <div className="text-center p-6 lg:p-8 bg-blue-50 rounded-xl">
            <p className="text-3xl lg:text-4xl font-bold text-blue-600 mb-2">{stats.technicalTrainings + stats.nonTechnicalTrainings}</p>
            <p className="text-sm lg:text-base text-gray-600 font-medium">Total Training Programs</p>
          </div>
          <div className="text-center p-6 lg:p-8 bg-purple-50 rounded-xl">
            <p className="text-3xl lg:text-4xl font-bold text-purple-600 mb-2">{stats.consultingServices}</p>
            <p className="text-sm lg:text-base text-gray-600 font-medium">Consulting Services</p>
          </div>
          <div className="text-center p-6 lg:p-8 bg-gray-50 rounded-xl">
            <p className="text-3xl lg:text-4xl font-bold text-gray-600 mb-2">{stats.contacts}</p>
            <p className="text-sm lg:text-base text-gray-600 font-medium">Pending Inquiries</p>
          </div>
        </div>
      </div>
    </div>

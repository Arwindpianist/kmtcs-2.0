        ...
        <div className="flex justify-between items-center">
          ...
          <div className="space-x-6 flex items-center">
            ...
            <div className="relative group">
              ...
              <div className={`absolute right-0 mt-1 w-48 bg-white rounded-lg shadow-lg overflow-hidden transition-all duration-200 ${isAboutOpen ? 'opacity-100 visible' : 'opacity-0 invisible'}`}>
                <Link 
                  href="/about" 
